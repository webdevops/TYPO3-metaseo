...
$tempColumns = array(
	'tx_metaseo_pagetitle'        => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_pagetitle',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_pagetitle_rel'    => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_pagetitle_rel',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_pagetitle_prefix' => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_pagetitle_prefix',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_pagetitle_suffix' => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_pagetitle_suffix',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_is_exclude'       => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_is_exclude',
		'exclude' => 1,
		'config'  => array(
			'type' => 'check'
		)
	...
	'tx_metaseo_canonicalurl'     => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_canonicalurl',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_priority'         => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_priority',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_geo_lat'          => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_geo_lat',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_geo_long'         => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_geo_long',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_geo_place'        => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_geo_place',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
	...
	'tx_metaseo_geo_region'       => array(
		'label'   => 'LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tx_metaseo_geo_region',
		'exclude' => 1,
		'config'  => array(
			'type'     => 'input',
			'size'     => '30',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes(
	'pages',
	'--div--;LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.tab.seo;,--palette--;LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.palette.pagetitle;tx_metaseo_pagetitle,--palette--;LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.palette.geo;tx_metaseo_geo,--palette--;LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.palette.crawler;tx_metaseo_crawler,--palette--;LLL:EXT:metaseo/Resources/Private/Language/locallang.tca.xml:pages.palette.sitemap;tx_metaseo_sitemap',
	'1,4,7,3',
	'after:author_email'
);
