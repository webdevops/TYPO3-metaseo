    ...
    'types' => array(
        '0' => array(
            'showitem'    => '--div--;LLL:EXT:metaseo/Resources/Private/Language/TCA/locallang.xlf:'
                ...
                . 'sitemap_priorty_depth_modificator,--div--;LLL:EXT:metaseo/Resources/Private/Language/TCA/locallang'
                . '.xlf:tx_metaseo_setting_root.tab.robotstxt,is_robotstxt;;pallette_robotstxt',
            'canNotCollapse' => '1'
        ),
    ),
    'palettes' => array(
        ...
        'pallette_robotstxt' => array(
            'showitem' => 'is_robotstxt_sitemap_static,--linebreak--,robotstxt,robotstxt_default,--linebreak--,'
